...
function verifyPopulate(data) {
  ...
  if(hashValue != "Hash: "){
    ...
    document.getElementById("myHash").innerHTML = "We have a problem. The Hash is not valid";
    $("#myHash").show();
    $("#verify").html('Rejected By Blockchain<i style="color:red; font-size: 1rem;" class="fas fa-times-circle"></i>');
    // $("#myHash").show();
  }
